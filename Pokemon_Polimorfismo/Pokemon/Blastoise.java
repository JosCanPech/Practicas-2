...
public class Blastoise extends Pokemon
     ...
     public Blastoise(String nombre, int nivel,int PS, int ataque,
        ...
        super(nombre, Tipo.AGUA, nivel, PS, ataque, defensa, ataqueespecial, defensaespecial,
                velocidad);
     ...
     public void RecibirAtaque(Movimiento movimiento, double efectividad){
        ...
        //Partes de la formula para calcular el daño inflijido
   ...
   @Override
     public double obtenerEfectividad(Tipo tipo, TipoMovimiento TipoMovimiento){
       ...
       switch(tipo) {
            case ACERO: efectividads *= 0.5; break;
            case FUEGO: efectividads *= 0.5; break;
            case HADA:  efectividads *= 0.5; break;
            case LUCHA: efectividads *= 0.5; break;
            case AGUA: efectividads *= 2; break;
            case ELECTRICO: efectividads *= 2; break;
            case BICHO: efectividads *= 0.25; break;
            case PLANTA: efectividads *= 0.25; break;
            case ROCA: efectividads *= 4; break;
            case TIERRA: efectividads *= 0; break;
        }
        return  efectividads;   
     }
